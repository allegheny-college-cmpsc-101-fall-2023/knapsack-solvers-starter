...
learn more about this assignment by reading the [Knapsack
Solvers](https://proactiveprogrammers.com/data-abstraction/source-code-surveys/knapsack-solvers/)
...
[knapsack-solvers-starter](https://github.com/ProactiveProgrammers/knapsack-solvers-starter).
...
- You may refer to the course textbook, the course slides, and the course web
  site for more details about the output that these programs should produce.
